        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ConnectedPersons_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "BirthDate", "City", "Gender", "Name", "PersonalNumber", "PhotoUrl", "Surname" },
                values: new object[] { -1, new DateTime(2024, 9, 15, 0, 0, 0, 0, DateTimeKind.Local), "Tbilisi", 1, "Default", "00000000000", null, "Test" });

            migrationBuilder.CreateIndex(
                name: "IX_ConnectedPersons_UserId",
